...
#End If
    ...
    Dim buf_chk(131) As Byte  '2026.06.21　
...
        'Me.TextBox1.Text &= dat & " "
    ...
    Private Sub SerialPort1_DataReceived(sender As Object, e As SerialDataReceivedEventArgs) Handles SerialPort1.DataReceived
        ...
        Dim ring_wp As Integer = 0 '2024.10.26
        Dim res_mod As Integer = 0 '2024.10.26

        While SerialPort1.BytesToRead > 0
            Dim receivedByte As Byte = SerialPort1.ReadByte()


            ring_wp = (ring_wp +1) mod 132
            res_mod = 131 - ring_wp
            buf_chk(res_mod) = receivedByte
            ...
            If (buf_chk(131) = &H50) And (buf_chk(130) = &H48) And (buf_chk(129) = &H30) Then 'PH0を検出
            ...
            If (data_out_res = 1) Then
                ...
                Dim byteArray_useful2() As Byte = {buf_chk(28), buf_chk(27), buf_chk(26), buf_chk(25), buf_chk(24), buf_chk(23), buf_chk(22), buf_chk(21)}
                ...
                Dim byteArray_average2() As Byte = {buf_chk(19), buf_chk(18), buf_chk(17), buf_chk(16), buf_chk(15), buf_chk(14), buf_chk(13), buf_chk(12)}
                ...
                Dim byteArray_diff2() As Byte = {buf_chk(10), buf_chk(9), buf_chk(8), buf_chk(7), buf_chk(6), buf_chk(5), buf_chk(4), buf_chk(3)}
                ...
                LED_ON_OFF2 = Chr(buf_chk(1))

                If buf_chk(1) = &H34 Then
